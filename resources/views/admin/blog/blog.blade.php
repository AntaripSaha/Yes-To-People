          ...
          <table class="table table-hover text-nowrap">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <img src="{{asset($blog->image)}}" width="80px" height="70px">
                </td>
                <td>
                  <a type="button" class="btn btn-outline-info btn-sm" href="{{route('admin.blog.view', ['id'=>$blog->id])}}">
                    View
                  </a>
                </td>
                <td>
                  <a type="button" class="btn btn-outline-danger btn-sm" onclick="return myFunction();" href="{{route('admin.blog.delete', ['id'=>$blog->id])}}">
                    Delete
                  </a>
                </td>
              </tr>
